#!/bin/bash
# Re-export models that failed with the dynamo exporter.
# The updated export_onnx.py now falls back to the legacy TorchScript exporter.
...
echo "═══════════════════════════════════════════"
echo "  Re-export failed models (6 models)"
echo "═══════════════════════════════════════════"
